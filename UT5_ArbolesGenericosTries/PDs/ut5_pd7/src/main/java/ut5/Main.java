...
public class Main {
    ...
    public static void main(String[] args){
        ...
        String[] lineasAbonados = ManejadorArchivosGenerico.leerArchivo("UT5_PD7\\codigo y datos pd7\\src\\abonados.txt");
        ...
        String[] codigos = ManejadorArchivosGenerico.leerArchivo("UT5_PD7\\codigo y datos pd7\\src\\codigos1.txt");
        ...
        ManejadorArchivosGenerico.escribirArchivo("UT5_PD7\\codigo y datos pd7\\src\\salida.txt", lineasSalida);
